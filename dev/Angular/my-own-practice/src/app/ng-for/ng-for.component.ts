...
@Component({
  selector: 'app-ng-for',
  imports: [FormsModule, NgFor, UpperCasePipe, LowerCasePipe, JsonPipe, DatePipe, NaPipe],
...
export class NgForComponent {
  ...
  employeeArray: any[]=[
    {empId: 121, name:'AAA', city:'', contactNo:'111111'},
    ...
    {empId: 125, name:null, city:'Thune', contactNo:'555555'} 
  ]
}
